...
class _NetworksPageState extends State<NetworksPage> {
  ...
  Future<void> _saveData() async {
    ...
    if (!_response) text = 'Ocurrió un error, intenta mas tarde';

    var _snackBar = SnackBar(content: Text(text));
              ...
              if (snapshot.hasData)
                return DropdownButtonHideUnderline(
                  ...
                  onChanged: (int _newValue) =>
                      _networksBloc.changeType(_network.itemId, _newValue),
      ...
      child: TextFormField(
        decoration: new InputDecoration(
          ...
          border: new OutlineInputBorder(
            ...
            borderSide: new BorderSide(color: Theme.Colors.loginGradientStart),
          ),
        ),
        onChanged: (String _newValue) =>
            _networksBloc.changeInput(_network.itemId, _newValue),
