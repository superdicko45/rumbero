...
import 'package:rumbero/ui/widgets/home/enlaces_swiper_widget.dart';
...
class _HomePageState extends State<HomePage>
  ...
  Widget _enlaces(List<EnlaceModelResponse> enlaces) {
    return enlaces.isNotEmpty ? EnlacesSwiper(enlaces: enlaces) : _emptyText();
  }

  Widget _blogs(List<BlogModelResponse> blogs) {
    return blogs.isNotEmpty ? BlogSlider(blogs: blogs) : _emptyText();
  }
