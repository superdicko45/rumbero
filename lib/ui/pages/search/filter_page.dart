...
class _FilterPageState extends State<FilterPage> {
  ...
  Widget _iTipo() {
    ...
    _items.forEach(
        (k, v) => _list.add(DropdownMenuItem<int>(value: k, child: Text(v))));
                    ...
                    return DropdownButtonHideUnderline(
                        child: DropdownButton<int>(
                            ...
                            onChanged: (int _newValue) =>
                                _filterBloc.changeTipo(_newValue),
                            items: _list));
                  else
                    return SizedBox();
                }),
                        ...
                        builder: (context, snapshot) {
                          return DropdownButtonHideUnderline(
                              child: DropdownButton<int>(
                                  ...
                                  isDense: true,
                                  onChanged: (int _newValue) =>
                                      _filterBloc.changeCiudad(_newValue),
            ...
            return Column(
              children: [
                ...
                RangeSlider(
                    ...
                    onChanged: (value) =>
                        _filterBloc.changeRan([value.start, value.end])),
                Padding(
            ...
            return Container(
              ...
              child: ChoiceChip(
                  ...
                  onSelected: (bool value) =>
                      _filterBloc.changeGenero(item.itemId, value)),
            );
          } else
            return SizedBox();
        });
    ...
    return StreamBuilder<int>(
        ...
        builder: (context, snapshot) {
          if (snapshot.data == 2) //eventos
            return Column(
              children: [_iDateP(context), _iTipoEvent()],
            );
          ...
          return MaterialButton(
              ...
              onPressed: () async {
                ...
                if (picked != null) {
                  ...
                  //if (picked[1] != null)
                  if (picked.length == 2) _filterBloc.changeMaxD(picked[1]);
                }
              },
                  ...
                  if (snapshot.hasData)
                    return DropdownButtonHideUnderline(
                        child: DropdownButton<int>(
                            ...
                            isDense: true,
                            onChanged: (int _newValue) =>
                                _filterBloc.changeTipoE(_newValue),
                            items: _list));
                  else
                    return SizedBox();
                }),
  ...
  Widget _iServicios() {
    return Padding(
      ...
      child: Column(
        children: [
          Text('SERVICIOS DE LAS ACADEMIAS'),
          ListTile(
              title: Text('Online'),
              subtitle: Padding(
                padding: const EdgeInsets.symmetric(vertical: 8.0),
                child: Text(
                    'Una opción que te permite encontrar academias con clases online.'),
              ),
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData)
                      return Switch(
                        ...
                        activeTrackColor:
                            Theme.Colors.loginGradientEnd.withOpacity(0.5),
                        activeColor: Theme.Colors.loginGradientEnd,
                      );
                    return SizedBox();
                  })),
          ListTile(
              ...
              subtitle: Padding(
                padding: const EdgeInsets.symmetric(vertical: 8.0),
                child: Text(
                    'Encuentra academias que se acoplen a tu ritmo de vida.'),
              ),
              trailing: StreamBuilder<bool>(
          ...
          ListTile(
              ...
              subtitle: Padding(
                padding: const EdgeInsets.symmetric(vertical: 8.0),
                child: Text(
                    'Si tus tiempos no te permiten practicar entre semana, deberias intentar esta opción.'),
              ),
              trailing: StreamBuilder<bool>(
