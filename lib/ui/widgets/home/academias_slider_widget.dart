...
class AcademySlider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      height: _orientation == Orientation.landscape ? 
        _screenSize.height * .8 : _screenSize.height * .3,
  ...
  Widget _card(BoxConstraints constraint, BuildContext context, double width, AcademyModelResponse academia){
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Chip(
                          ...
                          label: new Text(academia.stars == null 
                            ? '0.0'
