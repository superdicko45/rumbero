...
class ChangePassBloc with ValidatorProvider{
  ...
  Stream<String>    get rpassStream => _rpassSubject.transform(validarLenght)
    .doOnData((String confirmPassword){
      if(0 != _npassSubject.value.compareTo(confirmPassword)) _rpassSubject.addError("Contraseñas no coinciden");      
    });
