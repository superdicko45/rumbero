...
class SearchProvider{
  ...
  Future<List<String>> getSuggestions(String q) async {
    ...
    if (response.statusCode == 200) {
      ...
      suggestions.forEach((element) { results.add(element); });
  ...
  Future<List<EventModelResponse>> getEventos(Search filtro, String page) async {
    
    final String query = filtro.toString();

    print('$url/search/eventos?page=$page&$query');
  ...
  Future<List<AcademyModelResponse>> getAcademias(Search filtro, String page) async {
    
    final String query = filtro.toString();

    print('$url/search/academias?page=$page&$query');
    final response = await http.get('$url/search/academias?page=$page&$query');
  ...
  Future<List<UserModelResponse>> getUsuarios(Search filtro, String page) async {
    
    final String query = filtro.toString();

    print('$url/search/usuarios?page=$page&$query');
