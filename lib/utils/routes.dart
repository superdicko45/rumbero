...
class Router {
  static Route<dynamic> generateRoute(RouteSettings settings) {
    ...
    switch (settings.name) {
      ...
      case '/articles':
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => ArticlesPage(params: arguments));    
      case '/event':
        var arguments  = settings.arguments;
      ...
      case '/profile':
        var arguments = settings.arguments;
        return MaterialPageRoute(builder: (_) => UserPage(userId: arguments)); 
      case '/academy':
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => AcademyPage(params: arguments));

      //Paginas de busqueda
      case '/results':
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => ResultsPage(filtro: arguments,)); 
      case '/filter':  
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => FilterPage(filtro: arguments,));
      case '/results_events':
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => EventsListPage(params: arguments));
      case '/results_users':
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => UsersListPage(params: arguments));
      case '/results_schools':
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => SchoolsListPage(params: arguments));  
      case '/results_blogs':
      ...
      case '/login':
        var arguments  = settings.arguments;
        return MaterialPageRoute(builder: (_) => SignIn(redirectUrl: arguments));
      case '/resetEmail':
